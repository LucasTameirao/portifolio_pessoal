...
export const HeroSection: React.FC = () => {
  ...
  return (
    <div id="home" className="relative w-full text-slate-100 flex flex-col items-center">
      ...
      {/* ========================================================================= */}
      <section className="min-h-[85vh] sm:min-h-[90vh] w-full max-w-5xl mx-auto px-6 sm:px-12 pt-16 sm:pt-24 pb-12 flex flex-col justify-between">
        
        {/* Bloco de Apresentação de Texto */}
        <div className="space-y-6 sm:space-y-8 max-w-3xl pt-8">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-[50px] font-bold leading-[1.25] tracking-tight text-white/95">
      ...
      <section 
        id="about-section" 
        className="min-h-[85vh] sm:min-h-[90vh] w-full max-w-5xl mx-auto px-6 sm:px-12 pt-12 pb-16 flex flex-col justify-between"
      >
