...
export const ProjectDetailsModal: React.FC<ProjectDetailsModalProps> = ({
  ...
  // Manipulador para saída suave e fluida
  const handleSmoothClose = () => {
    setIsClosing(true);
    setTimeout(() => {
      onClose();
      // Garante scroll de volta para a seção de projetos
  ...
  return (
    <div
      className={`fixed inset-0 z-50 overflow-y-auto ${
        isClosing ? 'animate-pageExit' : 'animate-pageEnter'
      }`}
    >
      {/* Background com o mesmo Gradiente Fluido Animado da Página Principal */}
      <FluidBackground />

      {/* Camada de Contraste Suave para Leitura dos Textos */}
      <div className="min-h-screen w-full bg-slate-950/70 backdrop-blur-sm px-4 sm:px-6 lg:px-8 py-10 text-slate-100 flex flex-col justify-between relative z-10">
        ...
        <div className="w-full max-w-4xl mx-auto flex flex-col justify-between flex-1">
          ...
          <div className="space-y-6 pt-8">
            ...
            {/* Banner Principal do Projeto (com fallback elegante do Wireframe) */}
